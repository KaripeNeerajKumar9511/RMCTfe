...
export default function ParameterNames() {
  ...
  return (
    <div className="max-w-3xl animate-fade-in">
      <h1 className="text-xl font-bold flex items-center gap-2 mb-1 text-slate-900">
      ...
      <div className="mb-6 flex items-start gap-2 rounded-md px-3 py-2 text-xs text-slate-600 bg-slate-50 border border-slate-200">
